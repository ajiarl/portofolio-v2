...
export function Button({ className, variant = 'outline', ...props }: ButtonProps) {
  return (
    <button
      className={cn(
        "px-6 py-3 font-mono text-[12px] font-bold uppercase tracking-[0.05em]",
        "border transition-none duration-0 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed",
        {
